    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academy_or_school', models.CharField(choices=[('Litsey', 'Litsey'), ('Maktab', 'Maktab')], max_length=20)),
                ('class_name', models.CharField(max_length=20)),
                ('status', models.BooleanField(default=False)),
                ('districts', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_main.districts')),
